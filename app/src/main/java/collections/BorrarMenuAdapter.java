...
public class BorrarMenuAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup parent) {
      ...
      //  Glide.with(context).load("http://192.168.1.102:8000/api/v1.0/" + menus.get(i).getFoto()).into(image);
        ...
        borrar.setOnClickListener(new View.OnClickListener() {
            ...
            private void deleteMenu() {
                ...
                client.delete("http://192.168.1.102:8000/api/v1.0/menus" + "/" + id, new JsonHttpResponseHandler() {
                    @Override
