...
public class ResAdapter extends BaseAdapter {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        final String id;
        //Glide.with(context).load("http://192.168.1.102:8000/public/avatars" + restaurants.get(position).getImagen()).into(image);
        ...
        eliminar.setOnClickListener(new View.OnClickListener() {
            ...
            private void deleteMenu() {
                ...
                client.delete("http://192.168.1.102:8000/api/v1.0/restaurant" + "/" + id, new JsonHttpResponseHandler() {
                    @Override
